...
define Device/phytiumpi_firefly_4GB
  ...
  KERNEL := kernel-bin | gzip | fit gzip $(KDIR)/image-$$(DEVICE_DTS).dtb | check-size 12288k
  KERNEL_INITRAMFS := kernel-bin | gzip | fit gzip $(KDIR)/image-$$(DEVICE_DTS).dtb
  UBOOT_PATH := ./bin/fip-all-4GB.bin
  FILESYSTEMS := ext4
  IMAGES += factory.bin
  SUPPORTED_DEVICES := phytiumpi_firefly
  IMAGE/factory.bin := append-phytium-uboot | pad-to 4096k | append-kernel | pad-to 16384k |\
