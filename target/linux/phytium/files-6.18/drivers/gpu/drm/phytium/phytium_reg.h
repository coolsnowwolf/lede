...
#define DC_DITHER_CONFIG					0X1410
	#define ENABLE							0x80000000
#define DC_DITHER_TABLE_LOW					0x1420
	#define DITHER_TABLE_LOW				0x7B48F3C0
#define DC_DITHER_TABLE_HIGH				0X1428
	#define DITHER_TABLE_HIGH				0x596AD1E2
