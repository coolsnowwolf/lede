...
#define GROUP_MSG1_RETRY_EXEC_INTV		1000	/* 1 sec */
#define GROUP_MSG1_RETRY_EXEC_EXTEND	60000	/* 60 sec, When group retry counter > limit,  extend rekey time interval */
#define GROUP_KEY_UPDATE_EXEC_INTV		1000	/* 1 sec, for peridic group rekey timer */
