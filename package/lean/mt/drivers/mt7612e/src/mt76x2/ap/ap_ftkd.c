	...
	IN	INT32				KeyLen)
{
	...
	{
		RtmpPasswordHash((PSTRING)FT_KDP_KEY_DEFAULT,
					(PUCHAR)FT_KDP_RALINK_PASSPHRASE,
					strlen(FT_KDP_RALINK_PASSPHRASE),
					KeyMaterial);
	} /* End of if */
...
#endif /* FT_KDP_EMPTY */
} /* End of FT_KDP_NeighborReportHandle */
#endif /* FT_KDP_FUNC_INFO_BROADCAST */
...
#endif /* FT_KDP_EMPTY */
} /* End of FT_KDP_NeighborRequestHandle */
...
#endif /* FT_KDP_EMPTY */
} /* End of FT_KDP_NeighborResponseHandle */
