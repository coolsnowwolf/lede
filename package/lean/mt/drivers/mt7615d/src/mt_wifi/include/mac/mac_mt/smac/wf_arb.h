...
#define ARB_AIFSR1_BCN_AIFS_MASK        (0xf << 24)
#define ARB_AIFSR1_BCN_AIFS_HW_DEFAULT (0x3 << 24)
...
#define ARB_ACCWIR1_BCN_CWMIN_MASK       (0xff << 16)
#define ARB_ACCWIR1_BCN_CWMIN_HW_DEFAULT (0x3 << 16)
