...
#define TX_AGG_CNT_RANGE0_MASK  (0x3f)
#define TX_AGG_CNT_RANGE1_MASK  (0x3f << 8)
#define TX_AGG_CNT_RANGE2_MASK  (0x3f << 16)
#define GET_AGG_CNT_RANGE0(p)    (((p) & TX_AGG_CNT_RANGE0_MASK))
#define GET_AGG_CNT_RANGE1(p)    (((p) & TX_AGG_CNT_RANGE1_MASK) >> 8)
#define GET_AGG_CNT_RANGE2(p)    (((p) & TX_AGG_CNT_RANGE2_MASK) >> 16)
...
#define AGG_SCR		(WF_AGG_BASE + 0xd8)	/* 0x212d8 */
