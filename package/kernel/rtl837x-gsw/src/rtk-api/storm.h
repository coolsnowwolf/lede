 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtPortmask_set(rtk_uint32 portmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtPortmask_get(rtk_uint32 *pPortmask);
