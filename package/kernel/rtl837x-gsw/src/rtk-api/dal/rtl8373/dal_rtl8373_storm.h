...
#ifndef __DAL_RTL8373_STORM_H__
#define __DAL_RTL8373_STORM_H__
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlMeterIdx_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 index);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlMeterIdx_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlPortEnable_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t enable);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlPortEnable_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable);
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t dal_rtl8373_storm_bypass_set(rtk_storm_bypass_t type, rtk_enable_t enable);
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t dal_rtl8373_storm_bypass_get(rtk_storm_bypass_t type, rtk_enable_t *pEnable);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlExtPortmask_set(rtk_uint32 portmask);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlExtPortmask_get(rtk_uint32 *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlExtEnable_set(rtk_rate_storm_group_t stormType, rtk_enable_t enable);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlExtEnable_get(rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8373_rate_stormControlExtMeterIdx_set(rtk_rate_storm_group_t stormType, rtk_uint32 index);
