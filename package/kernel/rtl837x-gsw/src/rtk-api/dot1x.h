 ...
 */
extern rtk_api_ret_t rtk_dot1x_trap2CPU_Sel_set(rtk_dot1x_cpu_select_t cpu_sel);
 ...
 *      This API can set cpu config which unauth packet trap.
 */
extern rtk_api_ret_t rtk_dot1x_trap2CPU_Sel_get(rtk_dot1x_cpu_select_t *pCpu_sel);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_trap_priority_set(rtk_pri_t pri_value);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_trap_priority_get(rtk_pri_t *pri_value);
