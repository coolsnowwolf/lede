...
typedef enum rt_error_code_e
{
    ...
    RT_ERR_RANGE,                                      /* 0x00000017, out of range*/
    ...
    RT_ERR_INBW_RATE,                               /* 0x000c0005, invalid input bandwidth rate                                         */
    RT_ERR_INBW_PORT_ID,							/* 0x000c0006, invalid input bandwidth control port ID(0-8                          */ 
    ...
    RT_ERR_QOS_EBW_PORT_ID,                         /* 0x000d000b, invalid selection of priority source                                                 */
    ...
    RT_ERR_PHY_LINK_DOWN,                      		/* 0x000e000b, phy link down                                                 	    */
    ...
    RT_ERR_PTP_CLKOUTRUNSTOP= 0x00120000,
    RT_ERR_PTP_TIMESTAMP_INVALID,

    /* 0x00130000 for MACsec */
    RT_ERR_MACSEC_EGRESS_DEVICE = 0x00130000,    	/* 0x00130000, MACsec egress device ID error                              		  	*/
    RT_ERR_MACSEC_INGRESS_DEVICE = 0x00130001,   	/* 0x00130001, MACsec ingress device ID error                                 	   	*/

    /* 0x0014xxxx for I2C */
    RT_ERR_I2C_COMMAND_FAIL = 0x00140000,    		/* 0x00140000, Indicate i2c command execute error                   	            */
