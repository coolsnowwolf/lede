...
ECONET SOFTWARE.
***************************************************************/
#ifndef _QDMA_DEV_7552_H_
#define _QDMA_DEV_7552_H_
...
#if defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)
#define QDMA_LAN_DSCP_NUM_ONE_WLAN {256 , 256 , 128, 16 ,\
													 16 , 1024 , 8 , 16 ,\
													 16 , 16 , 16 , 128 , \
													 16 , 16 , 16 , 128}
#else /*defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)*/												 
#define QDMA_LAN_DSCP_NUM_ONE_WLAN {1024 , 1024 , 128, 16 ,\
													 16 , 4096 , 8 , 16 ,\
													 16 , 16 , 16 , 128 , \
													 16 , 16 , 16 , 128}
#endif /*defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)*/
...
#define QDMA_LAN_DSCP_NUM_OOKLA {256 , 256 , 16, 16 ,\
													 16 , 8 , 8 , 16 ,\
													 16 , 16 , 16 , 16 , \
													 16 , 16 , 16 , 16}
#ifdef TCSUPPORT_SPEEDTEST_OOKLA
#define QDMA_WAN_DSCP_NUM_DEFAULT {256 , 256 , 16, 16 ,\
													 16 , 8 , 8 , 16 ,\
													 16 , 16 , 16 , 16 , \
													 16 , 16 , 16 , 16}
#else
#define QDMA_WAN_DSCP_NUM_DEFAULT {256 , 256 , 128, 16 ,\
													 ...
													 16 , 16 , 16 , 16 , \
													 16 , 16 , 16 , 128}
#endif /* TCSUPPORT_SPEEDTEST_OOKLA */
...
#if defined(TCSUPPORT_SPEEDTEST_OOKLA)
...
#define QDMA_LAN_DSCP_NUM_DEFAULT QDMA_LAN_DSCP_NUM_TWO_WLAN
...
#else
#if defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)
	#define CONFIG_HWFWD_DSCP_NUM				(8192)
#else /*defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)*/
...
#endif
#if defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)
	#define CONFIG_HWFWD_DSCP_NUM_MAX			(8192)
	#define CONFIG_TX7_DSCP_NUM					(2048)
#else /*defined(CONFIG_TP_IMAGE) && defined(INCLUDE_SPEC_XX530v_COMBO)*/
    ...
    #define CONFIG_TX6_DSCP_NUM					(256)
#else
...
#define CONFIG_FLOWCNT_GRP0_MAX_IDX_NUM         (15)	/* ACNT_GRP[5:0], reduce to 16 */
...
#define FRAG_RX_RING_IDX 8
#define ASSE_RX_RING_IDX 9
