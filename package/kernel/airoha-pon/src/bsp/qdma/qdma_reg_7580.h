...
ECONET SOFTWARE.
***************************************************************/
#ifndef _QDMA_REG_7580_H_
#define _QDMA_REG_7580_H_
...
#else
#define QDMA_CSR_INT_EN(base,intNo,enNo) 			(base + 0x0024 + ((intNo-1)<<3) + (enNo<<2))
#endif
#else
...
#define QDMA_CSR_TX_CPU_DONE_NUM(base, idx)			(base+0x011C+RING_OFFSET(idx))
#endif
...
#else
#define QDMA_CSR_STATIC_QUEUE_THR(base, i)			(base+0x10b0+(i<<2))
#endif
...
#define GLB_CFG_RD_BYPASS_WR						(1<<17)
...
#else
#define INT1_TX_RING_MASK					        (0xFF)          /*Tx_Ring_0~7 binded to INT1*/
#endif
/*INT2*/
#if defined(TCSUPPORT_CPU_EN7581)
#define INT2_RX_RING_MASK					        (0x7FE00000)    /*Rx_Ring_23-30 binded to INT2, for LRO; Ring_21 for fragment Ring_22 for Reassemble */ 
#else
#define INT2_RX_RING_MASK					        (0x7C00)        /*Rx_Ring_11/12/13/14 binded to INT2, for LRO; Ring_10 for forward left to right */ 
#endif
#define INT2_TX_RING_MASK					        (0x0)
/*INT3*/
#define INT3_RX_RING_MASK					        (0x60)          /*Rx_Ring_5 for WIFI-2.4G */
#define INT3_TX_RING_MASK					        (0x0)
/*INT4*/
#if !defined(TCSUPPORT_NPU_WIFI_OFFLOAD) || defined(TCSUPPORT_TPCF_HAL)
#define INT4_RX_RING_MASK					        (0x0)          /*Rx_Ring_6 for WIFI-5G*/
#else
...
#else
#define IRQ_CFG_RINGIDX_MASK						(0x7<<IRQ_CFG_RINGIDX_SHIFT) /*8 tx rings*/
#define IRQ_CFG_IDX_MASK							0xFFF						 /*4K tx dscp*/
#endif
...
#if defined(TCSUPPORT_CPU_EN7581)
#define RX_RING_SIZE_MASK							(0xFFFF<<RX_RING_SIZE_SHIFT)
#else
#define RX_RING_SIZE_MASK							(0x1FFF<<RX_RING_SIZE_SHIFT)
#endif
#define RX_RING_LOW_THR_SHIFT						(16)
#if defined(TCSUPPORT_CPU_EN7581)
#define RX_RING_LOW_THR_MASK						(0xFFFF<<RX_RING_LOW_THR_SHIFT)
#else
...
#define DBG_CNTRMEM_TYPE_SHIFT						(5)
#define DBG_CNTRMEM_TYPE_MASK						(0x3<<DBG_CNTRMEM_TYPE_SHIFT)
#define DBG_CNTRMEM_CHNL_IDX_SHIFT					(0)
#define DBG_CNTRMEM_CHNL_IDX_MASK					(0x1F<<DBG_CNTRMEM_CHNL_IDX_SHIFT)
