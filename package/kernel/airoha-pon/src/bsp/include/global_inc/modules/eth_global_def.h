...
typedef enum
{
	...
	MIB_ID_TX_PKT_1024TO1518_CNT = 0x4050,
	MIB_ID_TX_PKT_1519TOMAX_CNT = 0x4054,
	...
	MIB_ID_RX_PKT_1024TO1518_CNT = 0x40BC,
	MIB_ID_RX_PKT_1519TOMAX_CNT = 0x40C0,
#endif
	MIB_ID_MAX,
...
typedef struct mt7530_switch_api_cnt_s
{
    ...
    u32 Tx1024_MAXBytePktsCnt;
	u32 Tx1024_1518BytePktsCnt;
	u32 Tx1519_MAXBytePktsCnt;
    ...
    u32 TxLateCollisionEvent;
    u32 TxExcessCollisionEvent;
    u32 TxDeferredEvent;
    u32 TxOverFlowFrameCnt;
    u32 TxInternalMacErrorCnt;
    u32 TXCarrierSenseErrorCnt;
	...
	u32 Rx1024_MAXBytePktsCnt;
	u32 Rx1024_1518BytePktsCnt;
	u32 Rx1519_MAXBytePktsCnt;
    u32 RxOverSizePktsCnt;
	
    u32 RxDropFramesCnt;
    u32 RxPauseFramesCnt;
    u32 RxCRCFramesCnt;
    u32 RxOverFlowFrameCnt;
    u32 RxFragmentErrorCnt;
    u32 RxJabberErrorCnt;
    u32 RxAlignmentErrorCnt;
...
typedef struct  mt7530_switch_api_wol_status_s
{
	u8 interrupt;
	u8 wuf_cnt;
	u8 mp_cnt;
	u8 da_cnt;
}mt7530_switch_api_wol_status_t, * mt7530_switch_api_wol_status_ptr;

#define WOL_MULTI_ADDRESS_NUMBER 8
typedef struct  mt7530_switch_api_wol_config_s
{
	u8 enable;
	u8 type;
	u8 sys_mac[6];
	u8 mul_mac[WOL_MULTI_ADDRESS_NUMBER][6];
	u8 index;
	u8 byte_mask[16];
	int byte_mask_num;
	u32 checksum;
	u32 final_byte;
	u32 match_len;
}mt7530_switch_api_wol_config_t, * mt7530_switch_api_wol_config_ptr;
...
#define REG_WAKE_INT_EN				(0x7E48)
#define WAKE_UNIPKT_INT_EN_OFFT 	(4)
#define WAKE_MULPKT_INT_EN_OFFT 	(5)
#define WAKE_BCPKT_INT_EN_OFFT  	(6)
#define WAKE_MAGIC_INT_EN_OFFT  	(7)

#define REG_WAKE_INT_STS			(0x7E4C)
#define REG_WAKE_INT_EN				(0x7E48)
#define REG_WUF_INT_EN				(0x7E50)
#define REG_WUF_INT_STS				(0x7E54)

#define REG_WUC1					(0x7E60)
#define WOL_WAKE_EN_DA_OFFT 		(0)
#define WOL_WAKE_EN_MP_OFFT 		(1)
#define WOL_ACCEPT_MULTI_OFFT 		(2)
#define WOL_ACCEPT_BROAD_OFFT 		(3)
#define WOL_WAKE_EN_WUF_OFFT 		(4)
#define WOL_WAKE_EN_LINK_OFFT 		(5)
#define WOL_SFT_RST 				(6)
#define REG_WUC2					(0x7E64)
#define REG_WUC3					(0x7E68)
#define REG_LNK_CHG_EN				(0x7E6C)

#define REG_WUF_EN 					(0x7E70)
#define REG_WOL_SMACCR0				(0x7E78)
#define REG_WOL_SMACCR1				(0x7E7C)

#define REG_WUF_MEM_CFG				(0x7E80)
#define WOL_WUFMEM_CFG_EN_OFFT 		(0)
#define WOL_WUFMEM_CFG_FUN_SEL_OFFT	(1)
#define WOL_WUFMEM_CFG_ADR_OFFT		(4)
#define REG_WUF_MEM_CFG_WDATA_L		(0x7E84)
#define REG_WUF_MEM_CFG_WDATA_H		(0x7E8C)

#define REG_MULTI_ADR_RG(n)			(0x7E98 + (n)*0x4)
#define REG_MATCH_LEN(n) 			(0x7EC8 + (n)*0x4)
#define REG_FINAL_BYTE(n) 			(0x7ED0 + (n)*0x4)
#define REG_EXP_CRC(n) 				(0x7ED8 + (n)*0x4)

#define REG_WAKE_CNT_DBG 			(0x7EF4)
#define WOL_WAKE_CNT_DA_OFFT		(0)
#define WOL_WAKE_CNT_MP_OFFT		(8)
#define WOL_WAKE_CNT_WUF_OFFT		(16)
#define WOL_WAKE_CNT_MASK			(0xFF)
#define WOL_WAKECNT_CNT_CLR			(31)

#define REG_WOL_DBG1 				(0x7EF8)
#define WOL_DBG_EN_OFFT				(0)
#define WOL_PME_WAKEUP_STS			(1)
