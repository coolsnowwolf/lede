...
typedef PACKING union
{
    PACKING struct
    {
        ...
        FIELD rsv_29                    : 3;
        FIELD other_mpcp_fwd            : 1;
        FIELD snf_mpcp_fwd              : 1;
#elif defined TCSUPPORT_CPU_EN7528 || defined(TCSUPPORT_CPU_EN7523) || defined(TCSUPPORT_CPU_AN7552)
        FIELD rsv_31                    : 1;
        FIELD rx_prmb_dtct_sel          : 2;
        FIELD other_mpcp_fwd            : 1;
        FIELD snf_mpcp_fwd              : 1;
#else
        FIELD rsv_27                    : 5;
        ...
        FIELD other_data_fwd            : 1;
        FIELD other_oam_fwd             : 1;
#else
        FIELD rsv_14                    : 2;
#endif
        FIELD rxmpi_stop                : 1;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_dscv_rdm_dly, *PREG_e_dscv_rdm_dly;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		FIELD rsv_h7					: 7;
		FIELD odd_llid_rpt_bitmap_ctrl	: 1;
		FIELD odd_llid_rpt_bitmap_set	: 8;
		FIELD rsv_l7					: 7;
		FIELD even_llid_rpt_bitmap_ctrl	: 1;
		FIELD even_llid_rpt_bitmap_set	: 8;
#else
		FIELD even_llid_rpt_bitmap_set	: 8;
		FIELD even_llid_rpt_bitmap_ctrl	: 1;
		FIELD rsv_l7					: 7;
	...
	UINT32 Raw;
} REG_e_report_ctrl, *PREG_e_report_ctrl;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		FIELD rsv_h7					: 7;
		FIELD llid1_rpt_bitmap_ctrl		: 1;
		FIELD llid1_rpt_bitmap_set		: 8;
		FIELD rsv_l7					: 7;
		FIELD llid0_rpt_bitmap_ctrl		: 1;
		FIELD llid0_rpt_bitmap_set		: 8;
#else
		FIELD llid0_rpt_bitmap_set		: 8;
		FIELD llid0_rpt_bitmap_ctrl		: 1;
		FIELD rsv_l7					: 7;
	...
	UINT32 Raw;
} REG_e_llid01_rpt_ctl, *PREG_e_llid01_rpt_ctl;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		FIELD rsv_h7					: 7;
		FIELD llid3_rpt_bitmap_ctrl		: 1;
		FIELD llid3_rpt_bitmap_set		: 8;
		FIELD rsv_l7					: 7;
		FIELD llid2_rpt_bitmap_ctrl		: 1;
		FIELD llid2_rpt_bitmap_set		: 8;
#else
		FIELD llid2_rpt_bitmap_set		: 8;
		FIELD llid2_rpt_bitmap_ctrl		: 1;
		FIELD rsv_l7					: 7;
	...
	UINT32 Raw;
} REG_e_llid23_rpt_ctl, *PREG_e_llid23_rpt_ctl;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		FIELD rsv_h7					: 7;
		FIELD llid5_rpt_bitmap_ctrl		: 1;
		FIELD llid5_rpt_bitmap_set		: 8;
		FIELD rsv_l7					: 7;
		FIELD llid4_rpt_bitmap_ctrl		: 1;
		FIELD llid4_rpt_bitmap_set		: 8;
#else
		FIELD llid4_rpt_bitmap_set		: 8;
		FIELD llid4_rpt_bitmap_ctrl		: 1;
		FIELD rsv_l7					: 7;
	...
	UINT32 Raw;
} REG_e_llid45_rpt_ctl, *PREG_e_llid45_rpt_ctl;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		FIELD rsv_h7					: 7;
		FIELD llid7_rpt_bitmap_ctrl		: 1;
		FIELD llid7_rpt_bitmap_set		: 8;
		FIELD rsv_l7					: 7;
		FIELD llid6_rpt_bitmap_ctrl		: 1;
		FIELD llid6_rpt_bitmap_set		: 8;
#else
		FIELD llid6_rpt_bitmap_set		: 8;
		FIELD llid6_rpt_bitmap_ctrl		: 1;
		FIELD rsv_l7					: 7;
	...
	UINT32 Raw;
} REG_e_llid67_rpt_ctl, *PREG_e_llid67_rpt_ctl;
...
typedef PACKING union
{
	PACKING struct
	{
		FIELD snf_pkt_cnt				: 32;
	}Bits;
	UINT32 Raw;
} REG_e_snf_pkt_cnt, *PREG_e_snf_pkt_cnt;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_rx_pkt_lch, *PREG_e_rx_pkt_lch;

typedef PACKING union
{
	PACKING struct
	{
		FIELD rx_prmb_1st_wd			: 32;
	}Bits;
	UINT32 Raw;
} REG_e_rx_prmb_1st_wd, *PREG_e_rx_prmb_1st_wd;
...
#ifdef __BIG_ENDIAN
		FIELD rsv_29					: 29;
		FIELD utili_ipg_sel				: 1;
		FIELD utili_cntclr				: 1;
		FIELD utili_chklen				: 1;
#else
		FIELD utili_chklen				: 1;
		FIELD utili_cntclr				: 1;
		FIELD utili_ipg_sel				: 1;
...
typedef PACKING union
{
	PACKING struct
	{
		FIELD utilt_clk_cycle_cnth32	: 32;
	}Bits;
	UINT32 Raw;
} REG_e_utili_clk_cycle_cnth, *PREG_e_utili_clk_cycle_cnth;

typedef PACKING union
{
	PACKING struct
	{
		FIELD utili_clk_cycle_cntl32	: 32;
	}Bits;
	UINT32 Raw;
} REG_e_utili_clk_cycle_cntl, *PREG_e_utili_clk_cycle_cntl;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_gnt_sizeh, *PREG_e_total_gnt_sizeh;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_gnt_sizel, *PREG_e_total_gnt_sizel;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_gnt_cnt, *PREG_e_total_gnt_cnt;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_pkt_sizeh, *PREG_e_total_pkt_sizeh;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_pkt_sizel, *PREG_e_total_pkt_sizel;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_total_pkt_cnt, *PREG_e_total_pkt_cnt;
...
typedef PACKING union
{
	...
	{
#ifdef __BIG_ENDIAN
		FIELD rxprmb_b5_err_cnt			: 8;
		FIELD rxprmb_sld_err_cnt		: 8;
		FIELD rxprmb_crc8_err_cnt		: 8;
		FIELD txmbi_req_cnt				: 8;
#else
		FIELD txmbi_req_cnt				: 8;
		FIELD rxprmb_crc8_err_cnt		: 8;
		FIELD rxprmb_sld_err_cnt		: 8;
	...
	UINT32 Raw;
} REG_e_rxerr_cnt, *PREG_e_rxerr_cnt;
...
typedef PACKING union
{
	...
	{
#ifdef __BIG_ENDIAN
		FIELD txmbi_pkt_cnt				: 8;
		FIELD txmpi_pkt_cnt				: 8;
		FIELD rxmbi_pkt_cnt				: 8;	
		FIELD rxmpi_pkt_cnt				: 8;	
#else
		FIELD rxmpi_pkt_cnt				: 8;
		FIELD rxmbi_pkt_cnt				: 8;
		FIELD txmpi_pkt_cnt				: 8;
	...
	UINT32 Raw;
} REG_e_trx_pkt_cnt, *PREG_e_trx_pkt_cnt;

typedef PACKING union
{
	PACKING struct
	{
		FIELD rx_crc32_err_cnt			: 32;
	}Bits;
	UINT32 Raw;
} REG_e_rx_crc32_cnt, *PREG_e_rx_crc32_cnt;
...
typedef PACKING union
{
	...
	UINT32 Raw;
} REG_e_tx_prmb_ctl, *PREG_e_tx_prmb_ctl;

typedef PACKING union
{
	PACKING struct
	{
		FIELD tx_crc32_cfg				: 32;
	}Bits;
	UINT32 Raw;
} REG_e_tx_crc32_cfg, *PREG_e_tx_crc32_cfg;
...
typedef PACKING union
{
	PACKING struct
	{
		...
		FIELD tx_prmb_sld				: 8;
		FIELD resv_21					: 21;
		FIELD lpbk_tx_prmb_b2_sel		: 1;
		FIELD tx_crc32_cfg_en			: 1;
		FIELD tx_prmb_crc8_en			: 1;
#else
		FIELD tx_prmb_crc8_en			: 1;
		FIELD tx_crc32_cfg_en			: 1;
		FIELD lpbk_tx_prmb_b2_sel		: 1;
	...
	UINT32 Raw;
} REG_e_tx_prmb_ctl2, *PREG_e_tx_prmb_ctl2;
...
typedef PACKING union
{
	...
	{
#ifdef __BIG_ENDIAN
		FIELD rdm_dly_len				: 16;
		FIELD rdm_dly_mode			    : 1;
		FIELD rdm_dly_min		        : 15;
#else
		FIELD rdm_dly_min		        : 15;
        FIELD rdm_dly_mode			    : 1;
        FIELD rdm_dly_len				: 16;
	...
	UINT32 Raw;
} REG_e_dscv_rdmdly_ctl, *PREG_e_dscv_rdmdly_ctl;
...
typedef PACKING union
{
	...
	{
#ifdef __BIG_ENDIAN
		FIELD rpt_bigpkt_fecon_adj	    : 16;
		FIELD rpt_bigpkt_fecoff_adj		: 16;
#else
		FIELD rpt_bigpkt_fecoff_adj		: 16;
        FIELD rpt_bigpkt_fecon_adj		: 16;
#endif
	...
	UINT32 Raw;
} REG_e_rpt_bigpkt_qs_ctl, *PREG_e_rpt_bigpkt_qs_ctl;
...
typedef volatile PACKING struct
{
    ...
    union
	{
		...
		REG_e_llid0_dscvry_sts			e_llid_dscvry_sts[8];// 602C~6048
    };
    ...
    REG_e_dscv_rdm_dly				e_dscv_rdm_dly;   //	61DC	
    REG_e_llid01_rpt_ctl			e_llid01_rpt_ctl; //61E0
    REG_e_llid23_rpt_ctl			e_llid23_rpt_ctl; //	61E4
	REG_e_llid45_rpt_ctl			e_llid45_rpt_ctl; //61E8
	REG_e_llid67_rpt_ctl			e_llid67_rpt_ctl; //61Ec
	REG_e_snf_pkt_cnt				e_snf_pkt_cnt;	  //61F0		
	REG_e_rx_pkt_lch				e_rx_pkt_lch;     //61F4
	REG_e_rx_prmb_1st_wd			e_rx_prmb_1st_wd; //61F8
	UINT32                          rsv_61fc; 	      //	61FC
	REG_e_utili_check				e_utili_check;	  //	6200
	REG_e_utili_clk_cycle_cnth      e_utili_clk_cycle_cnth; //6204
	REG_e_utili_clk_cycle_cntl      e_utili_clk_cycle_cntl; //6208
	REG_e_total_gnt_sizeh			e_total_gnt_sizeh;//	620C
	REG_e_total_gnt_sizel           e_total_gnt_sizel;//6210
	REG_e_total_gnt_cnt				e_total_gnt_cnt;  //6214
	REG_e_total_pkt_sizeh			e_total_pkt_sizeh;//6218
	REG_e_total_pkt_sizel			e_total_pkt_sizel;//621C
	REG_e_total_pkt_cnt				e_total_pkt_cnt;  //6220
	REG_e_rxerr_cnt					e_rxerr_cnt;	  //6224
	REG_e_trx_pkt_cnt				e_trx_pkt_cnt;	  //6228
	REG_e_rx_crc32_cnt				e_rx_crc32_cnt;   //622C
	REG_e_tx_prmb_ctl				e_tx_prmb_ctl;	  //6230
	REG_e_tx_crc32_cfg				e_tx_crc32_cfg;	  //6234
	REG_e_tx_prmb_ctl2				e_tx_prmb_ctl2;   //6238
    REG_e_dscv_rdmdly_ctl           e_dscv_rdmdly_ctl;//623C
    REG_e_rpt_bigpkt_qs_ctl         e_rpt_bigpkt_qs_ctl; //6240
    UINT32                          rsv_6244[8046];   // 6244..DFF8
    UINT8                           rsv_DFFC;         // DFFC
...
#define e_llid_dscvry_sts(i) \
({ \
	int idx = (i);\
	INREG32(&(EPON_MAC_BASE->e_llid_dscvry_sts[idx])); \
})
...
#define e_dscv_rdm_dly										   INREG32(&EPON_MAC_BASE->e_dscv_rdm_dly) //61DC
#define e_llid01_rpt_ctl									   INREG32(&EPON_MAC_BASE->e_llid01_rpt_ctl) //61E0
#define e_llid23_rpt_ctl									   INREG32(&EPON_MAC_BASE->e_llid23_rpt_ctl) //61E4
#define e_llid45_rpt_ctl 								       INREG32(&EPON_MAC_BASE->e_llid45_rpt_ctl) //61E8
#define e_llid67_rpt_ctl 								       INREG32(&EPON_MAC_BASE->e_llid67_rpt_ctl) //61EC	
#define e_snf_pkt_cnt        							       INREG32(&EPON_MAC_BASE->e_snf_pkt_cnt) //61F0
#define e_rx_pkt_lch								       	   INREG32(&EPON_MAC_BASE->e_rx_pkt_lch) //61F4
#define e_rx_prmb_1st_wd 								       INREG32(&EPON_MAC_BASE->e_rx_prmb_1st_wd) //61F8
#define e_utili_check 								       	   INREG32(&EPON_MAC_BASE->e_utili_check) //6200
#define e_utili_clk_cycle_cnth 								   INREG32(&EPON_MAC_BASE->e_utili_clk_cycle_cnth) //6204
#define e_utili_clk_cycle_cntl 								   INREG32(&EPON_MAC_BASE->e_utili_clk_cycle_cntl) //6208
#define e_total_gnt_sizeh 								   	   INREG32(&EPON_MAC_BASE->e_total_gnt_sizeh) //620C
#define e_total_gnt_sizel 								   	   INREG32(&EPON_MAC_BASE->e_total_gnt_sizel) //6210
#define e_total_gnt_cnt 								   	   INREG32(&EPON_MAC_BASE->e_total_gnt_cnt) //6214
#define e_total_pkt_sizeh 								   	   INREG32(&EPON_MAC_BASE->e_total_pkt_sizeh) //6218
#define e_total_pkt_sizel 								   	   INREG32(&EPON_MAC_BASE->e_total_pkt_sizel) //621C
#define e_total_pkt_cnt 								   	   INREG32(&EPON_MAC_BASE->e_total_pkt_cnt) //6220
#define e_rxerr_cnt 								   	   	   INREG32(&EPON_MAC_BASE->e_rxerr_cnt) //6224
#define e_trx_pkt_cnt 								   	   	   INREG32(&EPON_MAC_BASE->e_trx_pkt_cnt) //6228
#define e_rx_crc32_cnt 								   	   	   INREG32(&EPON_MAC_BASE->e_rx_crc32_cnt) //622C
#define e_tx_prmb_ctl 								   	   	   INREG32(&EPON_MAC_BASE->e_tx_prmb_ctl) //6230
#define e_tx_crc32_cfg 								   	   	   INREG32(&EPON_MAC_BASE->e_tx_crc32_cfg) //6234
#define e_tx_prmb_ctl2 								   	   	   INREG32(&EPON_MAC_BASE->e_tx_prmb_ctl2) //6238
#define e_dscv_rdmdly_ctl 								   	   INREG32(&EPON_MAC_BASE->e_dscv_rdmdly_ctl) //623c
#define e_rpt_bigpkt_qs_ctl                                    INREG32(&EPON_MAC_BASE->e_rpt_bigpkt_qs_ctl) //6240 
#endif
