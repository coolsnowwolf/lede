...
struct Gpon_Recovery_S{
	int allocId[GPON_TCONT_MAX_NUM];
	struct Gem_Recovery_Info gemPort[GPON_GEMPORT_MAX_NUM];
	int gemPortNum;
	int allocIdNum;
	unchar dbgPrint;
	GPON_DEV_ENCRYPT_KEY_INFO_T recoveraesKey;
	uint mibFlag;
};
