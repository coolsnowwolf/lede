...
ssize_t gpon_power_management_read_proc(struct file *file, char __user *buf, size_t count, loff_t *ppos);
ssize_t gpon_power_management_write_proc(struct file *file, const char __user *buf, size_t count, loff_t *ppos);
#else
