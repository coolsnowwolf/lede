...
#else	
        FIELD cal_gnt_size_done_int     : 1;
#endif
        FIELD rsv_13                    : 2;
#else
        FIELD rsv_13                    : 3;
#endif
        FIELD sn_req_recv_o5_int        : 1;
...
#else	
        FIELD cal_gnt_size_done_int_en  : 1;
#endif
        FIELD rsv_13                    : 2;
#else
        FIELD rsv_13                    : 3;
#endif
        FIELD sn_req_recv_o5_int_en     : 1;
...
typedef PACKING union
{
    ...
    UINT32 Raw;
} REG_G_MBI_MPI_STOP, *PREG_G_MBI_MPI_STOP;
...
#if defined(TCSUPPORT_CPU_EN7581) || defined(TCSUPPORT_CPU_EN7523)
        FIELD rsv_23                    : 9;
        FIELD my_bst_last_gnt_len_err   : 1;
#else
        FIELD rsv_22                    : 10;
#endif
...
typedef PACKING union
{
    ...
    {
#ifdef __BIG_ENDIAN
        FIELD gem_del_err_rid_en        : 1;
		FIELD ploamd_crc_err_rid_en		: 1;
		FIELD bwm_uc_err_rdi_en         : 1;
		FIELD blen_err_rdi_en           : 1;
		FIELD eth_fcs_err_rdi_en        : 1;
        FIELD rdi_send_err_thld         : 27;
#else
		FIELD rdi_send_err_thld         : 27;
		FIELD eth_fcs_err_rdi_en        : 1;
		FIELD blen_err_rdi_en           : 1;
    ...
    UINT32 Raw;
} REG_DBG_RDI_ERR_CTRL, *PREG_DBG_RDI_ERR_CTRL;

typedef PACKING union
{
	PACKING struct
    {
		FIELD rdi_err_cnt        : 32;
    } Bits;
    UINT32 Raw;
} REG_DBG_RDI_ERR_CNT, *PREG_DBG_RDI_ERR_CNT;
...
typedef PACKING union
{
...
#ifdef __BIG_ENDIAN
		union {
	        u16 dbg_yellow_slight_modify_size;
			struct{
				u16 yellow_shift_dir :1;
				u16 yellow_shift_size: 15;
			};
		};
		union {
	        u16 dbg_green_slight_modify_size;
			struct{
				u16 green_shift_dir :1;
				u16 green_shift_size: 15;
			};
		};
#else
        union {
    ...
    UINT32 Raw;
}  __attribute__((packed))REG_DBG_SLIGHT_MODIFY_SIZE_1, *PREG_DBG_SLIGHT_MODIFY_SIZE_1;
...
typedef PACKING union
{
    PACKING struct
    {
        ...
        u16 rsv_16                    ;
		union {
	        u16 dbg_total_slight_modify_size;
			struct{
				u16 dbg_total_shift_modify_direction :1;
				u16 dbg_total_shift_modify_size: 15;
			};
		};
#else
        union {
    ...
    UINT32 Raw;
}  __attribute__((packed))REG_DBG_SLIGHT_MODIFY_SIZE_2, *PREG_DBG_SLIGHT_MODIFY_SIZE_2;
...
#if defined(TCSUPPORT_CPU_EN7581) || defined(TCSUPPORT_CPU_AN7552)
        FIELD rsv_4                     : 4;
        FIELD dbg_us_snf_window_en      : 1;
        FIELD dbg_us_snf_en             : 1;
        FIELD dbg_ds_snf_en             : 1;
#else
        FIELD rsv_1                     : 7;
#endif
...
typedef PACKING union
{
    PACKING struct
    {
...
#if defined(TCSUPPORT_CPU_EN7581) || defined(TCSUPPORT_CPU_AN7552)
        FIELD rsv_22                    : 10;
        FIELD dbg_us_snf_fifo_empty     : 1;
        FIELD dbg_ds_snf_fifo_empty     : 1;
        FIELD rsv_17                    : 3;
#else
        FIELD rsv_17                    : 15;
#endif
        ...
        FIELD rsv_1                     : 5;
        FIELD dbg_us_gtc_sfc_fifo_udrn  : 1;
        FIELD dbg_us_gtc_sfc_fifo_ovrn  : 1;
...
typedef PACKING union
{
    ...
    UINT32 Raw;
} REG_CONSID_TX_RX_PH, *PREG_CONSID_TX_RX_PH;
...
typedef PACKING union
{
    ...
    UINT32 Raw;
} REG_PHY_RX_DLY, *PREG_PHY_RX_DLY;
...
typedef PACKING union
{
    PACKING struct
    {
        ...
        FIELD rsv_29                    : 2;
        FIELD cal_gnt_size_start        : 1;
        FIELD cal_gnt_size_alloc_id     : 12;
        FIELD cal_gnt_size_gtc_num      : 16;
#else
        FIELD cal_gnt_size_gtc_num      : 16;
        FIELD cal_gnt_size_alloc_id     : 12;
        FIELD cal_gnt_size_start        : 1;
...
typedef PACKING union
{
    PACKING struct
    {
        FIELD cal_gnt_size_sum          : 32;
    } Bits;
    UINT32 Raw;
} REG_CAL_GNT_SIZE_SUM, *PREG_CAL_GNT_SIZE_SUM;
#endif
...
typedef volatile PACKING struct
{
    ...
    union
	{
		...
		REG_G_TCONT_ID_0_1			G_TCONT_ID[8];// 4020~403C
    };
    ...
    REG_G_MBI_MPI_STOP              G_MBI_MPI_STOP;       // 4160
    ...
    REG_DBG_RDI_ERR_CTRL            DBG_RDI_ERR_CTRL;  // 4268
    REG_DBG_RDI_ERR_CNT             DBG_RDI_ERR_CNT;  // 426C
    UINT32                          rsv_4270[36];     // 4270..42FC
    ...
    REG_CONSID_TX_RX_PH             CONSID_TX_RX_PH;  // 43CC
    REG_CAL_GNT_SIZE_CTRL_STS       CAL_GNT_SIZE_CTRL_STS; // 43D0
#if defined(TCSUPPORT_CPU_EN7581) || defined(TCSUPPORT_CPU_AN7552)
    REG_CAL_GNT_SIZE_TCONT_EN       CAL_GNT_SIZE_TCONT_EN; // 43D4
    UINT32                          rsv_43D8;         // 43D8
    REG_CAL_GNT_ZERO_TCONT_STS      CAL_GNT_ZERO_TCONT_STS; // 43DC
    UINT32                          rsv_43E0;         // 43E0
    REG_PHY_RX_DLY                  PHY_RX_DLY;       // 43E4
    UINT32                          rsv_43E8;         // 43E8
    REG_CAL_GNT_SIZE_SUM_TCONT_SEL  CAL_GNT_SIZE_SUM_TCONT_SEL; // 43EC
    REG_CAL_GNT_SIZE_SUM_L32        CAL_GNT_SIZE_SUM_L32; // 43F0
    REG_CAL_GNT_SIZE_SUM_H32        CAL_GNT_SIZE_SUM_H32; // 43F4
#else
    REG_CAL_GNT_SIZE_SUM            CAL_GNT_SIZE_SUM; // 43D4
#endif
...
({ \
	int idx = (i);\
	INREG32(&(gpon_mac_reg_BASE->G_TCONT_ID[idx])); \
})
...
#define G_MBI_MPI_STOP                                         INREG32(&gpon_mac_reg_BASE->G_MBI_MPI_STOP) // 4160
...
#define DBG_RDI_ERR_CTRL                                       INREG32(&gpon_mac_reg_BASE->DBG_RDI_ERR_CTRL) // 4268
#define DBG_RDI_ERR_CNT                                        INREG32(&gpon_mac_reg_BASE->DBG_RDI_ERR_CNT) // 426C
...
#define CONSID_TX_RX_PH                                        INREG32(&gpon_mac_reg_BASE->CONSID_TX_RX_PH) // 43CC
#define CAL_GNT_SIZE_CTRL_STS                                  INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_CTRL_STS) // 43D0
#if defined(TCSUPPORT_CPU_EN7581) || defined(TCSUPPORT_CPU_AN7552)
#define CAL_GNT_SIZE_TCONT_EN                                  INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_TCONT_EN) // 43D4
#define CAL_GNT_ZERO_TCONT_STS                                 INREG32(&gpon_mac_reg_BASE->CAL_GNT_ZERO_TCONT_STS) // 43DC
#define PHY_RX_DLY                                             INREG32(&gpon_mac_reg_BASE->PHY_RX_DLY) // 43E4
#define CAL_GNT_SIZE_SUM_TCONT_SEL                             INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_SUM_TCONT_SEL) // 43EC
#define CAL_GNT_SIZE_SUM_L32                                   INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_SUM_L32) // 43F0
#define CAL_GNT_SIZE_SUM_H32                                   INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_SUM_H32) // 43F4

#else
#define CAL_GNT_SIZE_SUM                                       INREG32(&gpon_mac_reg_BASE->CAL_GNT_SIZE_SUM) // 43D4
#endif
...
#define G_MBI_MPI_STOP_FLD_mpi_tx_stop_done                    REG_FLD(1, 31)
#define G_MBI_MPI_STOP_FLD_mpi_rx_stop_done                    REG_FLD(1, 30)
#define G_MBI_MPI_STOP_FLD_mpi_tx_stop                         REG_FLD(1, 24)
#define G_MBI_MPI_STOP_FLD_mpi_rx_stop                         REG_FLD(1, 16)
#define G_MBI_MPI_STOP_FLD_mbi_tx_stop_done                    REG_FLD(1, 15)
#define G_MBI_MPI_STOP_FLD_mbi_rx_stop_done                    REG_FLD(1, 14)
#endif
#define G_MBI_MPI_STOP_FLD_mbi_tx_stop                         REG_FLD(1, 8)
#define G_MBI_MPI_STOP_FLD_mbi_rx_stop                         REG_FLD(1, 0)
...
#if defined(TCSUPPORT_CPU_EN7580) || defined(TCSUPPORT_CPU_EN7528)
#define G_MBI_MPI_STOP_GET_mpi_tx_stop_done(reg32)             REG_FLD_GET(G_MBI_MPI_STOP_FLD_mpi_tx_stop_done, (reg32))
#define G_MBI_MPI_STOP_GET_mpi_rx_stop_done(reg32)             REG_FLD_GET(G_MBI_MPI_STOP_FLD_mpi_rx_stop_done, (reg32))
#define G_MBI_MPI_STOP_GET_mpi_tx_stop(reg32)                  REG_FLD_GET(G_MBI_MPI_STOP_FLD_mpi_tx_stop, (reg32))
#define G_MBI_MPI_STOP_GET_mpi_rx_stop(reg32)                  REG_FLD_GET(G_MBI_MPI_STOP_FLD_mpi_rx_stop, (reg32))
#define G_MBI_MPI_STOP_GET_mbi_tx_stop_done(reg32)             REG_FLD_GET(G_MBI_MPI_STOP_FLD_mbi_tx_stop_done, (reg32))
#define G_MBI_MPI_STOP_GET_mbi_rx_stop_done(reg32)             REG_FLD_GET(G_MBI_MPI_STOP_FLD_mbi_rx_stop_done, (reg32))
#endif
#define G_MBI_MPI_STOP_GET_mbi_tx_stop(reg32)                  REG_FLD_GET(G_MBI_MPI_STOP_FLD_mbi_tx_stop, (reg32))
#define G_MBI_MPI_STOP_GET_mbi_rx_stop(reg32)                  REG_FLD_GET(G_MBI_MPI_STOP_FLD_mbi_rx_stop, (reg32))
...
#if defined(TCSUPPORT_CPU_EN7580) || defined(TCSUPPORT_CPU_EN7528)
#define G_MBI_MPI_STOP_SET_mpi_tx_stop_done(reg32, val)        REG_FLD_SET(G_MBI_MPI_STOP_FLD_mpi_tx_stop_done, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mpi_rx_stop_done(reg32, val)        REG_FLD_SET(G_MBI_MPI_STOP_FLD_mpi_rx_stop_done, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mpi_tx_stop(reg32, val)             REG_FLD_SET(G_MBI_MPI_STOP_FLD_mpi_tx_stop, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mpi_rx_stop(reg32, val)             REG_FLD_SET(G_MBI_MPI_STOP_FLD_mpi_rx_stop, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mbi_tx_stop_done(reg32, val)        REG_FLD_SET(G_MBI_MPI_STOP_FLD_mbi_tx_stop_done, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mbi_rx_stop_done(reg32, val)        REG_FLD_SET(G_MBI_MPI_STOP_FLD_mbi_rx_stop_done, (reg32), (val))
#endif
#define G_MBI_MPI_STOP_SET_mbi_tx_stop(reg32, val)             REG_FLD_SET(G_MBI_MPI_STOP_FLD_mbi_tx_stop, (reg32), (val))
#define G_MBI_MPI_STOP_SET_mbi_rx_stop(reg32, val)             REG_FLD_SET(G_MBI_MPI_STOP_FLD_mbi_rx_stop, (reg32), (val))
...
#if defined(TCSUPPORT_CPU_EN7580) || defined(TCSUPPORT_CPU_EN7528)
#define G_MBI_MPI_STOP_VAL_mpi_tx_stop_done(val)               REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mpi_tx_stop_done, (val))
#define G_MBI_MPI_STOP_VAL_mpi_rx_stop_done(val)               REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mpi_rx_stop_done, (val))
#define G_MBI_MPI_STOP_VAL_mpi_tx_stop(val)                    REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mpi_tx_stop, (val))
#define G_MBI_MPI_STOP_VAL_mpi_rx_stop(val)                    REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mpi_rx_stop, (val))
#define G_MBI_MPI_STOP_VAL_mbi_tx_stop_done(val)               REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mbi_tx_stop_done, (val))
#define G_MBI_MPI_STOP_VAL_mbi_rx_stop_done(val)               REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mbi_rx_stop_done, (val))
#endif
#define G_MBI_MPI_STOP_VAL_mbi_tx_stop(val)                    REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mbi_tx_stop, (val))
#define G_MBI_MPI_STOP_VAL_mbi_rx_stop(val)                    REG_FLD_VAL(G_MBI_MPI_STOP_FLD_mbi_rx_stop, (val))
