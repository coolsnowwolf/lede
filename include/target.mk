...
default-settings luci-app-ddns luci-app-upnp luci-app-adbyby-plus luci-app-autoreboot \
luci-app-filetransfer luci-app-ssr-plus luci-app-unblockmusic \
luci-app-mwan3 luci-app-ramfree \
